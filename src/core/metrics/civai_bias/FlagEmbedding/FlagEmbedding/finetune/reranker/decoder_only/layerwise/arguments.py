...
class RerankerModelArguments(AbsRerankerModelArguments):
    ...
    start_layer: int = field(default=8, metadata={"help": "which layer to start to compute score"})

    head_multi: bool = field(default=False, metadata={"help": "use one / multi classifier"})
