...
class ModelArgs:
    ...
    attn_impl: Optional[str] = field(
        default="sdpa", metadata={"help": "The implementation of attention."}
    )
    ...
    beacon_param: Optional[List[str]] = field(
        default=None, metadata={"help": "The introduced parameters for beacon."}
    )
    ...
    retrieval_method: Optional[str] = field(
        default=None, metadata={"help": "How to retrieve? {bm25}"}
    )
    retrieval_topk: Optional[int] = field(
        default=None, metadata={"help": "How many windows to retrieve?"}
    )
    retrieval_key_length: Optional[int] = field(
        default=None, metadata={"help": "The key sequence length in retrieval."}
    )
...
class TrainingArgs(TrainingArguments):
    ...
    # ==============================
    use_colossal: bool = field(default=False, metadata={"help": "Use colossal trainer?"})
    colossal_plugin: str = field(
        default="gemini", metadata={"help": "The plugin name for colossalai."}
    )
    colossal_mp: str = field(
        default="bf16", metadata={"help": "The mixed precision for colossalai."}
    )
