...
class ModelArguments:
    ...
    cache_dir: str = field(default="../LMs")
    from_peft: str = field(default=None)
    modules_to_save: str = field(default=None)
    raw_peft: str = field(default=None)


@dataclass
class DataArguments:
    train_data: str = field(default="cfli/bge-e5data", metadata={"help": "Path to train data"})
    ...
    query_instruction_for_retrieval: str = field(default="query: ", metadata={"help": "query: "})
