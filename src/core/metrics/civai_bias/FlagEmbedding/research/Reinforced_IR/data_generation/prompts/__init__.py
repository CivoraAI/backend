...
from .train_prompts import generate_train_answer, generate_train_query, generate_train_query_type2
...
from .teacher_prompts import get_yes_prompt, rank_prompt, get_rank_prompt
