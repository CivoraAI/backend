...
class EvalArgs:
    ...
    batch_size: int = field(default=32, metadata={"help": "Search batch size."})
...
def main():
    ...
    for lang in languages:
        ...
        queries, qids = get_queries_and_qids(
            eval_args.qa_data_dir, lang=lang, add_instruction=model_args.add_instruction
        )
