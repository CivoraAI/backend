...
class EvalArgs:
    ...
    search_result_save_dir: str = field(
        ...
        metadata={
            "help": "Dir to saving search results. Search results path is `result_save_dir/{model_name_or_path}/{lang}.txt`"
        },
    )
    ...
    eval_result_save_dir: str = field(
        ...
        metadata={
            "help": "Dir to saving evaluation results. Evaluation results will be saved to `eval_result_save_dir/{model_name_or_path}.json`"
        },
    )
    threads: int = field(
...
def main():
    ...
    if eval_args.threads > 1:
        ...
        for lang in languages:
            ...
            search_result_save_dir = os.path.join(
                eval_args.search_result_save_dir, os.path.basename(eval_args.model_name_or_path)
            )
    ...
    save_results(
        ...
        save_path=os.path.join(
            eval_args.eval_result_save_dir, f"{os.path.basename(eval_args.model_name_or_path)}.json"
        ),
