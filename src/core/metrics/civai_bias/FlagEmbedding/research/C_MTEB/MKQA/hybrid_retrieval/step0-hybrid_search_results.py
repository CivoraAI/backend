...
class EvalArgs:
    ...
    dense_weight: float = field(default=1, metadata={"help": "Hybrid weight of dense score"})
...
def save_hybrid_results(
    sparse_search_result_path: str,
    dense_search_result_path: str,
