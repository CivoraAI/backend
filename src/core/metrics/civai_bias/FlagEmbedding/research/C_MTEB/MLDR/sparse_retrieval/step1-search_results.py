...
class EvalArgs:
    ...
    encoded_query_and_corpus_save_dir: str = field(
        ...
        metadata={
            "help": "Dir to save encoded queries and corpus. Encoded queries and corpus are saved in `save_dir/{encoder_name}/{lang}/query_embd.tsv` and `save_dir/{encoder_name}/{lang}/corpus/corpus_embd.jsonl`, individually."
        },
    )
...
def main():
    ...
    for lang in languages:
        ...
        index_save_dir = os.path.join(
            eval_args.encoded_query_and_corpus_save_dir, os.path.basename(encoder), lang, "index"
        )
