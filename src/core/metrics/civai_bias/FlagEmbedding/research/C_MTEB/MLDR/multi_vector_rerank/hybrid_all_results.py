...
class EvalArgs:
    ...
    languages: str = field(
        default="en",
        metadata={
            "help": "Languages to evaluate. Avaliable languages: ar de en es fr hi it ja ko pt ru th zh",
            "nargs": "+",
        },
    )
    top_k: int = field(
    ...
    dense_weight: float = field(default=0.15, metadata={"help": "Hybrid weight of dense score"})
    sparse_weight: float = field(default=0.5, metadata={"help": "Hybrid weight of sparse score"})
    colbert_weight: float = field(default=0.35, metadata={"help": "Hybrid weight of colbert score"})
...
def save_hybrid_results(
    ...
    qid_list = list(
        ...
        | set(dense_search_result_dict.keys() | set(colbert_search_result_dict.keys()))
    )
    hybrid_results_list = []
