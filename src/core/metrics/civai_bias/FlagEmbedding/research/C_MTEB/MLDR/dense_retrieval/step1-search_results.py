...
class EvalArgs:
    ...
    index_save_dir: str = field(
        ...
        metadata={
            "help": "Dir to index and docid. Corpus index path is `index_save_dir/{encoder_name}/{lang}/index`. Corpus ids path is `index_save_dir/{encoder_name}/{lang}/docid` ."
        },
    )
...
def main():
    ...
    for lang in languages:
        ...
        search_results = searcher.batch_search(
            queries=queries, q_ids=qids, k=eval_args.hits, threads=eval_args.threads
        )
