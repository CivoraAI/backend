...
class EvalArgs:
    ...
    max_query_length: int = field(default=512, metadata={"help": "Max text length."})
    max_passage_length: int = field(default=8192, metadata={"help": "Max text length."})
    batch_size: int = field(default=256, metadata={"help": "Inference batch size."})
    top_k: int = field(
        default=100, metadata={"help": "Use reranker to rerank top-k retrieval results"}
    )
    ...
    dense_weight: float = field(
        default=0.15, metadata={"help": "The weight of dense score when hybriding all scores"}
    )
    sparse_weight: float = field(
        default=0.5, metadata={"help": "The weight of sparse score when hybriding all scores"}
    )
    colbert_weight: float = field(
        default=0.35, metadata={"help": "The weight of colbert score when hybriding all scores"}
    )
