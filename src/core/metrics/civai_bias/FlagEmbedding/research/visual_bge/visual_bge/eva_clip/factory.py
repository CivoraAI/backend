    ...
    if pretrained and pretrained.lower() == "openai":
        ...
        if custom_clip:
            ...
            model = CustomCLIP(
                **model_cfg,
                ...
                is_only_visual=is_only_visual,
                is_only_text=is_only_text,
            )
        else:
            model = CLIP(**model_cfg, cast_dtype=cast_dtype)
            print(
                "Not CustomCLIP: If you have set building only visual or text tower, you may still get a complete CLIP model."
            )
        ...
        if pretrained:
            ...
            if checkpoint_path:
                ...
                load_checkpoint(
                    model, checkpoint_path, model_key="model|module|state_dict", strict=False
                )
            else:
                error_str = (
