...
def get_args():
    ...
    parser.add_argument(
        "--range_for_sampling", default="10-210", type=str, help="range to sample negatives"
    )
...
def find_knn_neg(
    model, input_file, candidate_pool, output_file, sample_range, negative_number, use_gpu
):
    corpus = []
    queries = []
    train_data = []
