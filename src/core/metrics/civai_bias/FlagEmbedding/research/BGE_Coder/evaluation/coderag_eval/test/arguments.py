...
class CodeRAGEvalArgs:
    ...
    max_length: int = field(default=2048, metadata={"help": "Max length to use for evaluation."})
    ...
    results_file: str = field(
        ...
        metadata={"help": "Specify the filepath if you want to save the retrieval results."},
    )
